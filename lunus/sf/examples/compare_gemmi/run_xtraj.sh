...
exec python "${REPO_ROOT}/lunus/command_line/xtraj.py" ${ARGS}
...
#exec python "${REPO_ROOT}/lunus/command_line/xtraj.py" top=top_ref_bfac.pdb use_top_bfacs=True traj=${XTRAJ_DATA}/traj_ref.xtc first=0 last=9 d_min=1.8 unit_cell=84.522,84.522,76.623,90.00,90.00,90.00 space_group=P41 fcalc=fcalc_${var}.mtz icalc=icalc_${var}.mtz diffuse=diffuse_${var}.hkl engine=${var} torch_device=mps
#
...
#exec python "${REPO_ROOT}/lunus/command_line/xtraj.py" ${ARGS} unit_cell=88.451,88.451,39.823,90.00,90.00,90.00 space_group=P43
#

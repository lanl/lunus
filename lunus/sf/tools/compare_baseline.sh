...
# Still lunus/sf: the baseline worktree is checked out at ${BASELINE},
# which predates the move of xtraj.py into lunus/command_line/.
...
echo; echo "=== current ==="
( cd "${REPO_ROOT}/lunus/command_line" && PYTHONPATH="${REPO_ROOT}" "${PY[@]}" xtraj.py \
